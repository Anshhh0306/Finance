...
(() => {
  ...
  var GraduationCap = createLucideIcon("GraduationCap", __iconNode5);
  ...
  var PiggyBank = createLucideIcon("PiggyBank", __iconNode6);
  ...
  var Plane = createLucideIcon("Plane", __iconNode7);
  ...
  var RotateCcw = createLucideIcon("RotateCcw", __iconNode8);
  ...
  var ShieldCheck = createLucideIcon("ShieldCheck", __iconNode9);
  ...
  var SlidersVertical = createLucideIcon("SlidersVertical", __iconNode10);
  ...
  var Sparkles = createLucideIcon("Sparkles", __iconNode11);
  ...
  var ThumbsDown = createLucideIcon("ThumbsDown", __iconNode12);
  ...
  var ThumbsUp = createLucideIcon("ThumbsUp", __iconNode13);
  ...
  var TrendingUp = createLucideIcon("TrendingUp", __iconNode14);
  ...
  var TriangleAlert = createLucideIcon("TriangleAlert", __iconNode15);
  ...
  var ExtensionCommitGuardModal = ({
    ...
    return /* @__PURE__ */ import_react3.default.createElement(
      ...
      /* @__PURE__ */ import_react3.default.createElement("div", { className: "commitguard-card" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex items-center justify-between px-6 py-3.5 border-b border-slate-100 bg-white" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex items-center gap-2.5 text-slate-900 font-bold text-base sm:text-lg" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: `p-1.5 rounded-lg text-white shadow-sm ${surfaceType === "TRAVEL" ? "bg-sky-600" : surfaceType === "EDTECH" ? "bg-indigo-600" : "bg-emerald-600"}` }, surfaceType === "TRAVEL" ? /* @__PURE__ */ import_react3.default.createElement(Plane, { className: "w-5 h-5" }) : surfaceType === "EDTECH" ? /* @__PURE__ */ import_react3.default.createElement(GraduationCap, { className: "w-5 h-5" }) : /* @__PURE__ */ import_react3.default.createElement(Sparkles, { className: "w-5 h-5" })), /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("span", { className: "text-slate-900" }, surfaceType === "TRAVEL" ? "CommitGuard Travel: TNPL & EMI Reality Check" : surfaceType === "EDTECH" ? "CommitGuard EdTech: Education Loan Subvention Truth" : "CommitGuard Smart Checkout Intel"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-[11px] text-slate-500 font-normal" }, surfaceType === "TRAVEL" ? "MakeMyTrip & Cleartrip: High-APR TNPL Cascades vs 6M Liquid SIP" : surfaceType === "EDTECH" ? "UpGrad: Exposing Hidden Subvention Surcharges & True Debt ROI" : "Live Card & EMI Optimization for Flipkart & Amazon"))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex items-center gap-3" }, /* @__PURE__ */ import_react3.default.createElement("span", { className: "hidden sm:inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 text-[11px] font-mono font-medium" }, /* @__PURE__ */ import_react3.default.createElement("span", { className: "w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" }), /* @__PURE__ */ import_react3.default.createElement("span", null, "<1.2ms Real-Time Scraper")), /* @__PURE__ */ import_react3.default.createElement(
        "button",
        {
      ...
      ))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-4 rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50/80 via-white to-teal-50/50 shadow-sm space-y-3" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-1 rounded-md bg-emerald-600 text-white" }, /* @__PURE__ */ import_react3.default.createElement(TrendingUp, { className: "w-3.5 h-3.5" })), /* @__PURE__ */ import_react3.default.createElement("div", null, /* @__PURE__ */ import_react3.default.createElement("h4", { className: "text-xs font-bold text-slate-900 uppercase tracking-wide" }, "Friction Recovery & Compounding Matrix"), /* @__PURE__ */ import_react3.default.createElement("p", { className: "text-[10px] text-slate-500" }, "Preserve leaked bank fees & GST by paying upfront into a ", /* @__PURE__ */ import_react3.default.createElement("strong", null, "7.10% Sovereign T-Bill")))), /* @__PURE__ */ import_react3.default.createElement("span", { className: "text-[10px] font-mono font-bold px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-300" }, "RBI Benchmark 7.10%")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "grid grid-cols-3 gap-2 pt-1" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-2.5 rounded-lg bg-white border border-emerald-100 shadow-2xs text-center" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, "1 Year T-Bill"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-sm sm:text-base font-black text-slate-900 mt-0.5" }, "\u20B9", recoveryCompounding.fv1Year.toLocaleString("en-IN")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-[9px] text-emerald-700 font-semibold mt-0.5" }, "Preserves \u20B9", recoveryCompounding.savedFriction.toLocaleString("en-IN"))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-2.5 rounded-lg bg-white border border-emerald-100 shadow-2xs text-center" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-[10px] font-bold text-slate-500 uppercase" }, "3 Year Compound"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-sm sm:text-base font-black text-emerald-700 mt-0.5" }, "\u20B9", recoveryCompounding.fv3Year.toLocaleString("en-IN")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-[9px] text-emerald-600 font-semibold mt-0.5" }, "+\u20B9", (recoveryCompounding.fv3Year - recoveryCompounding.savedFriction).toLocaleString("en-IN"), " yield")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-2.5 rounded-lg bg-emerald-900 text-white shadow-2xs text-center" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-[10px] font-bold text-emerald-300 uppercase" }, "5 Year Wealth"), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-sm sm:text-base font-black text-white mt-0.5" }, "\u20B9", recoveryCompounding.fv5Year.toLocaleString("en-IN")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-[9px] text-emerald-200 font-semibold mt-0.5" }, "+\u20B9", recoveryCompounding.compoundedGain5Y.toLocaleString("en-IN"), " pure gain"))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "p-2.5 rounded-lg bg-slate-900 text-white text-xs flex items-center justify-between gap-2" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ import_react3.default.createElement(PiggyBank, { className: "w-4 h-4 text-emerald-400 shrink-0" }), /* @__PURE__ */ import_react3.default.createElement("span", { className: "text-[11px] text-slate-200" }, "Invest \u20B9", mathResult.monthlyBaseEmi.toLocaleString("en-IN"), "/mo in Liquid Fund SIP instead:")), /* @__PURE__ */ import_react3.default.createElement("div", { className: "text-right shrink-0" }, /* @__PURE__ */ import_react3.default.createElement("span", { className: "text-xs font-black text-emerald-400" }, "\u20B9", recoveryCompounding.sipFv.toLocaleString("en-IN")), /* @__PURE__ */ import_react3.default.createElement("span", { className: "text-[9px] text-slate-400 block font-mono" }, "(+\u20B9", recoveryCompounding.sipGain.toLocaleString("en-IN"), " yield vs -\u20B9", recoveryCompounding.savedFriction, " leak)")))), /* @__PURE__ */ import_react3.default.createElement("div", { className: "border border-slate-200 rounded-xl overflow-hidden bg-white" }, /* @__PURE__ */ import_react3.default.createElement(
        "button",
        {
