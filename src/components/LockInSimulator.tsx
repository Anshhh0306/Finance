...
export const LockInSimulator: React.FC<LockInSimulatorProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="p-4 rounded-xl bg-surface-100 border border-white/5 space-y-2.5">
        <div className="flex items-center justify-between text-xs">
          <span className="font-semibold text-slate-200">
            Simulate Premature Liquidation Month:
          </span>
          <span className="font-mono px-2 py-0.5 rounded bg-brand-500/20 text-brand-100 border border-brand-500/30 font-bold">
        ...
        <input
          ...
          className="w-full h-2 bg-surface-300 rounded-lg appearance-none cursor-pointer accent-brand-500"
        />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {/* Broken FD Column */}
        <div className="p-4 rounded-xl bg-surface-100 border border-accent-rose/20 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-300 flex items-center gap-1.5">
              <TrendingDown className="w-3.5 h-3.5 text-accent-rose" />
              Premature Broken FD
            </span>
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-accent-rose/10 text-accent-rose font-mono">
        ...
        <div className="p-4 rounded-xl bg-surface-100 border border-accent-emerald/20 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-300 flex items-center gap-1.5">
              <CheckCircle2 className="w-3.5 h-3.5 text-accent-emerald" />
              Zero-Penalty Liquid Fund
            </span>
            <span className="text-[10px] px-1.5 py-0.5 rounded bg-accent-emerald/10 text-accent-emerald font-mono">
              6.75% Benchmark
            </span>
          </div>
      ...
      {math.isLiquidityTrap && (
        <div className="p-3 rounded-xl bg-accent-rose/10 border border-accent-rose/20 flex items-start gap-2.5 text-xs text-rose-200">
