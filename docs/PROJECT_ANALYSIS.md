...
## 2. Competitive Moat (The 4 Unique Pillars)
...
- **Proactive Financial Check-Ins:** The AI reaches out with timely prompts:
  > *"You have $350 unallocated surplus this month. Want to see how splitting this between Gold and Tech ETFs impacts your 3-year emergency goal?"*
...
* **PII Stripping & Anonymized AI Prompts:** The AI backend only receives mathematical contexts without sensitive personal identifiers (no names, bank account numbers, or addresses).
...
## 3. Real-World User Personas & User Stories
...
* **App Experience:** Uploads past bank statements. The AI parses the data locally, calculates surplus cash flow, and simulates low-volatility asset allocations to meet the 3-year deadline safely.

---

## 4. Team Task Distribution & Feature Backlog

Use this table to divide tasks among team members:

| Module / Area | Features to Build | Suggested Tech |
| :--- | :--- | :--- |
| **Frontend & UI/UX** | • Interactive Chat Interface<br>• Asset Allocation Pie Charts<br>• Scenario Simulation Sliders & Graphs | React / Next.js / TailwindCSS / Chart.js |
...
## 5. How Team Members Can Contribute & Push Code
